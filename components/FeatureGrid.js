    ...
    <div className="   container mx-auto text-lg text-gray-500 text-justify grid  grid-cols-1 p-4 m-10 sm:grid-cols-2">
      ...
      <div className=" px-4 mb-6 flex">
        <div className=" pt-4">
          ...
          about the medical device sector. We can support you with any of your
          business needs no matter the size. Our expertise lies in areas such as
          sales and marketing, strategy, digital marketing set up and ongoing
          infrastructure support, increasing the effectiveness of your sales
          force, developing internal training programs or developing external
          professional education courses. We also support new product
          introduction in ANZ. Provide sales support to boost current portfolios
          or distribute your products if you do not have a presence in ANZ
          already, allowing you to utilise our extensive network of clients and
          medical facilities.
        </div>
      </div>
      ...
      <div className=" px-4 mb-6 flex">
        <div className=" pt-4">
          ...
          to the healthcare system. Supporting charities is also important to
          us. We actively fundraise and volunteer for Camp Quality and Oxfam. We
          also believe we need to not just talk about a sustainable future but
          act on it now, so we are aiming for carbon neutrality by 2023.
        </div>
      </div>
      <div className="px-4 flex">
        <div className=" pt-4 ">
